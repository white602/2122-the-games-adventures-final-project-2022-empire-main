// stolen from @types/emscripten/index.d.ts, cuz definition files aren't importable :P
...
export type { WebAssembly, Emscripten, EmscriptenModule, EmscriptenModuleFactory, FS, MEMFS, NODEFS, IDBFS, StringToType, ArgsToType, ReturnToType };
export type {
    cwrap, ccall, getValue, setValue, allocate, stackAlloc, stackSave, stackRestore, UTF8ToString,
    stringToUTF8, lengthBytesUTF8, allocateUTF8, allocateUTF8OnStack, UTF16ToString, stringToUTF16,
    lengthBytesUTF16, UTF32ToString, stringToUTF32, lengthBytesUTF32, intArrayFromString, intArrayToString,
    writeStringToMemory, writeArrayToMemory, writeAsciiToMemory, addRunDependency, removeRunDependency,
    addFunction, removeFunction, ALLOC_NORMAL, ALLOC_STACK, ALLOC_DYNAMIC, ALLOC_NONE
};